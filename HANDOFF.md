...
현재 스크린은 rfsinopale 저장소의 **gh-pages**에 있는 2채널 Electron 앱입니다. gamepoem도 **gh-pages**가 최신입니다. 아래 9월 24일의 video-editing 브랜치/브라우저 상영 안내는 이전 구조입니다.

스크린 실행·재편집은 rfsinopale의 README.md와 docs/picture-edit-v1.md를 기준으로 합니다. 같은 room `sinopale`로 아이패드를 연결합니다. 문장 하나가 완성되면 바닥 출력에만 잠시 나타납니다. 읽기로 확정한 시는 회차 종료 시 기존 시 엔딩으로 전달됩니다. 프로토콜은 기존 태블릿과 호환됩니다.
